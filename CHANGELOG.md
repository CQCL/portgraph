...
## [0.13.0](https://github.com/CQCL/portgraph/compare/v0.12.3...v0.13.0) - 2024-11-20
...
- [**breaking**] Manual impl of `Region`/`FlatRegion` for improved perf ([#162](https://github.com/CQCL/portgraph/pull/162))
